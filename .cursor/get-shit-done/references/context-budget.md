...
The keys live in `.claude/settings.json` (project) or `/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
