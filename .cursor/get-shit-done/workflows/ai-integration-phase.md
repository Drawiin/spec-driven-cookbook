...
<required_reading>
@/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/references/ai-frameworks.md
@/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/agents/gsd-eval-planner.md for instructions.
