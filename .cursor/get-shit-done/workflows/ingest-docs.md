...
```bash
INIT=$(node "/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
