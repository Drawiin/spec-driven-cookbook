...
INSTALL_JS_GLOBAL="/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
