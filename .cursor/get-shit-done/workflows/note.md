...
- **Global scope**: `/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/notes/`)
...
2. Glob `/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/viniciusguimaraes/personal-projects/spec-driven-cookbook/.cursor/notes/` — works in any directory
