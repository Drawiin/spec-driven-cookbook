---
source_file: "research/prototype/planning/phases/01-tooling-foundation/01-02-PLAN.md"
type: "document"
...
# Phase 1 Plan 02 (tool-context-builder)

## Connections
- [[Phase 1 Pattern Map]] - `references` [EXTRACTED]
- [[Phase 1 Plan 01 (tool-env-check walking skeleton)]] - `depends_on` [EXTRACTED]
...
- [[TOOL-02 (context-builder scripts)]] - `implements` [EXTRACTED]
- [[TOOL-05 (self-contained skill folder)]] - `implements` [EXTRACTED]
- [[context_builder.py (tool-context-builder)]] - `implements` [EXTRACTED]
